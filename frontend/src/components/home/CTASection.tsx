          ...
          <FadeIn>
            <div className="bg-primary rounded-3xl p-8 md:p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-white/90 text-sm">
                <a href="tel:+919999999999" className="flex items-center space-x-2 hover:text-white transition-colors">
                  <Phone className="w-4 h-4" />
                  <span>+91 99999 99999</span>
                </a>
                <div className="hidden sm:block w-1 h-1 rounded-full bg-white/50" />
                <a href="mailto:info@krivox.com" className="flex items-center space-x-2 hover:text-white transition-colors">
                  <Mail className="w-4 h-4" />
                  <span>info@krivox.com</span>
                </a>
              </div>
            </div>
          </FadeIn>
